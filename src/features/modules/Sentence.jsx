...
const Sentence = ({ courses }) => {
    ...
    const handleGenerate = async () => {
        ...
        const loadingToastId = toast.loading("Uploading sentences...");
        ...
        try {
            ...
            toast.success(`✅ Sentences uploaded! ${response.data.count} items created`, {
                id: loadingToastId
            });
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-6">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-xl">
                        ...
                        <div
                            ...
                            className="cursor-pointer border-2 border-dashed rounded-2xl p-12 text-center transition border-gray-300 hover:border-blue-400"
                        >
                            {excelFile ? (
                ...
                <div className="mt-8 flex justify-center">
                    ...
                    >
                        {isGenerating ? "Generating..." : "Generate Sentence Videos"}
                    </button>
                </div>
