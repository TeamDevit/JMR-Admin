...
  const initialDuration = selectedCourse.durationDays || 8;
  const [days, setDays] = useState(
    Array.from({ length: initialDuration }, (_, i) => `Day ${i + 1}`)
  );
...
    navigate(`/courses/${selectedCourse.id}/days/${day.replace(' ', '-')}`, { state: { selectedCourse, selectedDay: day } });
  };
...
        <button
          onClick={() => navigate('/courses')} // Use navigate for back button
