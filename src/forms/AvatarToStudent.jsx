...
const handleDownloadTemplate = () => {
  ...
  link.href = "/templates/avatar_student_template.xlsx"; // relative path in public folder
  link.download = "avatar_student_template.xlsx";       // suggested download filename
