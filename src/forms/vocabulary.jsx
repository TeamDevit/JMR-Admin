  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-start p-8 font-sans relative">
      ...
      <button
        ...
        className="self-start mb-6 px-4 py-2 bg-slate-900 text-white font-semibold rounded-lg shadow-md
                   hover:bg-blue-600 transition-colors duration-200"
      >
        ← back  
      </button>

      {/* Header container with Generate button */}
      <div className="w-full max-w-6xl relative flex items-center justify-center mb-8">
        ...
        <button
          ...
          className="absolute top-0 right-0 px-[3em] py-[1.3em] text-[12px] uppercase tracking-[2.5px] font-medium text-black
